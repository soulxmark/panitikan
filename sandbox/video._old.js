...
const VIDEOS = [
  // ── Documentaries ──
{ 
    id: 'Oj-5IFlzTYQ', // Inalis ang playlist link para gumana ang embed
    cat: 'animated', 
    badge: 'ani', 
    badgeLabel: 'ANIMATED',
    title: 'El Filibusterismo | Kabanata 1: Sa Kubyerta',
    desc: 'Isang animated na paglalakbay sa Bapor Tabo kung saan ipinapakita ang diskriminasyon at ang radikal na mungkahi ni Simoun.',
    source: 'YouTube', 
    lang: 'Filipino', 
    dur: '3m 19s' // In-update ang tamang haba ng video
  },
  { id: 'gpmb6dgpnow&list', // Inalis ang playlist link para gumana ang embed
    cat: 'animated', 
    badge: 'ani', 
    badgeLabel: 'ANIMATED',
