...
const VIDEOS = [
 ...
 // Kabanata (Minecraft Version)
{ 
  id: 'B70UuAtKygs', 
  cat: 'Minecraft Version', 
  badge: 'book', 
  badgeLabel: 'KABANATA 11',
  title: 'Los Baños', 
  desc: 'Ang pangangaso ng Kapitan Heneral at ang pagpapasya sa akademya ng wikang Kastila.', 
...
{ 
  ...
  cat: 'Minecraft Version', 
  badge: 'book', 
  badgeLabel: 'KABANATA 12',
  title: 'Placido Penitente', 
  desc: 'Ang kawalan ng gana ni Placido sa pag-aaral dahil sa bulok na sistema ng edukasyon.', 
  source: 'YouTube', lang: 'Filipino', dur: 'Aralin' 
}, 
{ 
  id: 'P1qHYN3Z8Zk', 
  cat: 'Minecraft Version', 
  badge: 'book', 
  badgeLabel: 'KABANATA 13',
  title: 'Ang Klase sa Pisika', 
  desc: 'Ang pagtatalo sa pagitan nina Padre Millon at Placido sa loob ng silid-aralan.', 
  source: 'YouTube', lang: 'Filipino', dur: 'Aralin' 
}, 
{ 
  id: 'kN5QbkxlGgo', 
  ...
  title: 'Sa Bahay ng mga Estudyante', 
  desc: 'Ang pagpupulong ng mga estudyante tungkol sa panukalang akademya.', 
  source: 'YouTube', lang: 'Filipino', dur: 'Aralin' 
}, 
{ 
  id: 'HJNt8VBhEIk', 
  cat: 'Minecraft Version', 
  badge: 'book', 
  badgeLabel: 'KABANATA 15',
  title: 'Si Ginoong Pasta', 
  desc: 'Ang paghingi ng tulong ni Isagani sa tanyag na manananggol na si Ginoong Pasta.', 
  source: 'YouTube', lang: 'Filipino', dur: 'Aralin' 
}, 
{ 
  id: 'Y_-zFsm1edk', 
  cat: 'Minecraft Version', 
  badge: 'book', 
  badgeLabel: 'KABANATA 16',
  title: 'Ang Kasawian ng Isang Intsek', 
  desc: 'Ang handaan ni Quiroga at ang pagpapakita ng mga suliraning panlipunan.', 
  source: 'YouTube', lang: 'Filipino', dur: 'Aralin' 
},
{ 
  id: 'UQG3ORgCksc', 
  cat: 'Minecraft Version', 
  badge: 'book', 
  badgeLabel: 'KABANATA 17',
  title: 'Ang Perya sa Quiapo', 
  desc: 'Ang pagbisita sa perya at ang pagmamasid sa mga estatwa at kultura.', 
  source: 'YouTube', lang: 'Filipino', dur: 'Aralin' 
}, 
{ 
  id: 'QIk7IK9_z3A', 
  cat: 'Minecraft Version', 
  badge: 'book', 
  badgeLabel: 'KABANATA 18',
  title: 'Ang mga Pandaraya', 
  desc: 'Ang pagtatanghal ni Mr. Leeds at ang ulong nagsasalita na si Imuthis.', 
  source: 'YouTube', lang: 'Filipino', dur: 'Aralin' 
} 
];
...
const VID_CATS = [
  ...
  { key: "Minecraft Version", label: "KABANATA 11-18" },
  { key: "animated", label: "Animated" },
];

let videoBuilt = false;
function buildVideo() {
  if (videoBuilt) return;
  videoBuilt = true;
